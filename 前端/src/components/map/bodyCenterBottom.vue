      ...
      <el-col :lg="9" :md="9" :sm="24" :xs="24">
        <div style="height: 100%;">
          ...
          <div class="amounts-box">
            <div class="amounts-box-card">
              <div>
                <span class="amounts-title">问卷</span>
          ...
          <div class="amounts-total-card">
            <div class="amounts-total">
              <div>
                ...
                <span class="amounts-total-title">当天</span>
              </div>
              <div>
            ...
            <div class="amounts-total">
              <div>
                ...
                <span class="amounts-total-title">当周</span>
              </div>
              <div>
            ...
            <div class="amounts-total">
              <div>
                ...
                <span class="amounts-total-title">当月</span>
              </div>
              <div>
            ...
            <div class="amounts-total">
              <div>
                ...
                <span class="amounts-total-title">当季</span>
              </div>
              <div>
