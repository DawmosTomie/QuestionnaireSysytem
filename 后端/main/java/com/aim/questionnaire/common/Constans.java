...
public class Constans {
    ...
    /** 验证码状态： 0 待发送 */
    public static String validCodeStatus_0 = "0";
    /** 验证码状态： 1 已发送 */
    public static String validCodeStatus_1 = "1";
    /** 验证码状态： 2 已验证 */
    public static String validCodeStatus_2 = "2";
    /** 验证码状态： 3 发送失败 */
    public static String validCodeStatus_3 = "3";
    /** 验证码状态： 4 发送中 */
    public static String validCodeStatus_4 = "4";
    /** 验证码状态： 5 失效 */
    public static String validCodeStatus_5 = "5";

    /** 验证码类型： 01 注册 */
    public static String validCodeType_01 = "01";
    /** 验证码类型： 02 登录 */
    public static String validCodeType_02 = "02";
    /** 验证码类型： 03 支付 */
    public static String validCodeType_03 = "03";
    /** 验证码类型： 04 密码设置 */
    public static String validCodeType_04 = "04";
}
